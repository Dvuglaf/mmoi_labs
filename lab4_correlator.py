...
def main():
    ...
    black_background = np.zeros((64, 64), dtype=np.int32)

    # Изображения с объектами на черном фоне
    objects_t = image_with_objects(black_background, 4, t)  # буквы Т размером 3х3
    objects_rev_t = image_with_objects(black_background, 4, rev_t)  # перевернутые буквы Т размером 3х3
    objects_t_and_rev_t = objects_t + objects_rev_t  # буквы Т и перевернутые буквы Т размером 3х3

    noise_background = np.random.normal(0, np.sqrt(np.var(objects_t)), (64, 64)).astype(
    ...
    g_none_1 = thresholding(R_image_none_1, 0.9)
    g_none_2 = thresholding(R_image_none_2, 0.9)

    g_with_t_1 = thresholding(R_image_with_t_1, 0.9)
    g_with_t_2 = thresholding(R_image_with_t_2, 0.9)

    g_with_rev_t_1 = thresholding(R_image_with_rev_t_1, 0.9)
    g_with_rev_t_2 = thresholding(R_image_with_rev_t_2, 0.9)

    g_with_t_and_rev_t_1 = thresholding(R_image_with_t_and_rev_t_1, 0.9)
    g_with_t_and_rev_t_2 = thresholding(R_image_with_t_and_rev_t_2, 0.9)
